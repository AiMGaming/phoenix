<template>
  <v-app light id="Phoenix"
         v-bind:class="{ loginGradient: showGradientBackground}"
         v-bind:style="showImageBackground ? { 'background-image': 'url('+configuration.theme.logo.loginBackground+')',
...
export default {
  ...
  computed: {
    ...
    showGradientBackground () {
      ...
      return !this.configuration.theme.logo.loginBackground
    },
    showImageBackground () {
      if (!this.showBackground) {
        return false
